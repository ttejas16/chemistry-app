...
import com.example.chemapp.databinding.MolarCalculatorBinding;
...
public class MolarCalculator extends AppCompatActivity {
    ...
    private MolarCalculatorBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = MolarCalculatorBinding.inflate(getLayoutInflater());
    ...
    public void showResultAlert(String salt, String res){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(MolarCalculator.this);
